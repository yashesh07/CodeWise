...
class _AnalysisScreenState extends State<AnalysisScreen> {
  ...
  void initState() {
    ...
    _trackballBehavior = TrackballBehavior(enable: true, tooltipDisplayMode: TrackballDisplayMode.floatAllPoints,);
    _tooltipBehavior2 = TooltipBehavior(enable: true);
    _trackballBehavior2 = TrackballBehavior(enable: true, tooltipDisplayMode: TrackballDisplayMode.floatAllPoints,);
  }
    ...
    return SafeArea(
      child: Column(
        children: [
          ...
          const Center(child: Text('Interactive Graphs', style: TextStyle(fontSize: 25),)),
          const SizedBox(height: 20,),
        Expanded(
        child: ListView(
          children: [
                  ...
                  return SfCartesianChart(
                    ...
                    series: <ChartSeries>[
                      LineSeries<RatingDataPerContest, int>(
                        ...
                        xValueMapper: (RatingDataPerContest data, _) => data.index,
                        yValueMapper: (RatingDataPerContest data, _) => data.newRating,
                  ...
                  return SfCartesianChart(
                      ...
                      series: <ChartSeries>[
                        WaterfallSeries<RatingDataPerContest, int>(
                            ...
                            xValueMapper: (RatingDataPerContest data, _) => data.index,
                            yValueMapper: (RatingDataPerContest data, _) => data.newRating-data.oldRating,
